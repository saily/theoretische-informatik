...
\section{Mengen}
    ...
    \begin{align}
    &cf_A :\mathbb{N} \longrightarrow \mathbb{N}
        && \text{rekursive (entscheidbare) Funktion, wenn berechenbar}\\
        &&&: \text{ wird gesprochen: $cf_A$ total von $A$ nach $B$}\nonumber\\
    &df_A :\subseteq \mathbb{N} \longrightarrow \mathbb{N}
        && \text{rekursiv aufzählbare Funktion, wenn berechenbar}\\
        &&&:\subseteq \text{ wird gesprochen: $df_A$ partiell von $A$ nach $B$}
        \nonumber\\
